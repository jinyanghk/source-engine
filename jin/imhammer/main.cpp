...
struct GraphEditorDelegate : public GraphEditor::Delegate
{
    ...
    static const inline GraphEditor::Template mTemplates[] = {
        {IM_COL32(160, 160, 180, 255),
         ...
         1,
         Array<const char *, 1>{"MyInput"},
         nullptr,
         2,
         Array<const char *, 2>{"MyOutput0", "MyOuput1"},
         nullptr},
        ...
        {IM_COL32(180, 160, 160, 255),
         ...
         3,
         nullptr,
         Array<ImU32, 3>{IM_COL32(200, 100, 100, 255), IM_COL32(100, 200, 100, 255), IM_COL32(100, 100, 200, 255)},
         1,
         Array<const char *, 1>{"MyOutput0"},
         Array<ImU32, 1>{IM_COL32(200, 200, 200, 255)}}};
...
static const char *VectorEditorEditKindName(ImVectorEditor::EditKind kind)
{
    switch (kind)
    {
    case ImVectorEditor::EditKind::MoveAnchor:
        return "Move Anchor";
    case ImVectorEditor::EditKind::MoveHandle:
        return "Move Handle";
    case ImVectorEditor::EditKind::AddAnchor:
        return "Add Anchor";
    case ImVectorEditor::EditKind::DeleteAnchor:
        return "Delete Anchor";
    case ImVectorEditor::EditKind::AddHandle:
        return "Add Handles";
    case ImVectorEditor::EditKind::DeleteHandle:
        return "Delete Handles";
    case ImVectorEditor::EditKind::ChangePointMode:
        return "Change Point Mode";
    case ImVectorEditor::EditKind::PathOperation:
...
static void ShowVectorEditorDemo()
{
    ...
    if (ImGui::RadioButton("Corner##VectorEditor", selectedMode == ImVectorEditor::HandleMode::Corner) && hasSelection)
    {
        undoDebug.BeginEdit(path.anchors[selectedAnchor].hasHandleIn || path.anchors[selectedAnchor].hasHandleOut
                                ...
                                : ImVectorEditor::EditKind::ChangePointMode,
                            selectedAnchor);
