...
//-----------------------------------------------------------------------------
class CShaderAPIVK : public IShaderAPI, public IHardwareConfigInternal, public IDebugTextureInfo
{
public:
	// constructor, destructor
	CShaderAPIVK( );
	virtual ~CShaderAPIVK();
...
static CShaderAPIVK g_ShaderAPIGL;

EXPOSE_SINGLE_INTERFACE_GLOBALVAR( CShaderAPIVK, IMaterialSystemHardwareConfig, 
				MATERIALSYSTEM_HARDWARECONFIG_INTERFACE_VERSION, g_ShaderAPIGL )

EXPOSE_SINGLE_INTERFACE_GLOBALVAR( CShaderAPIVK, IDebugTextureInfo, 
